...
{
var _tmp438: (int, machine);
var _tmp439: (machine, int);
var _tmp440: machine;


PaxosNode_myRank = PaxosNode_Init_entry50_payload.0;

_tmp438 = (PaxosNode_myRank, this);

PaxosNode_currentLeader = _tmp438;
...
_tmp440 = new Timer(_tmp439);

PaxosNode_timer = _tmp440;
...
fun PaxosNode_Init_exit0_rand_1004962824()
{
...
fun PaxosNode_PerformOperation_entry0_rand_2055431763()
{
...
fun PaxosNode_PerformOperation_exit0_rand_1247339603()
{
...
{
var _tmp441: (int, int);
var _tmp442: ((int, int), int);
var _tmp443: (int, int);
var _tmp444: (machine, int, (int, int));
...
PaxosNode_receivedAgree = _tmp442;

_tmp443 = (PaxosNode_nextProposal.0, PaxosNode_myRank);

_tmp444 = (this, PaxosNode_nextSlotForProposer, _tmp443);

PaxosNode_BroadCastAcceptors(prepare, _tmp444);
...
fun PaxosNode_ProposeValuePhase1_exit0_rand_805977634()
{
...
{
var _tmp445: (machine, int, (int, int), int);
...
_tmp445 = (this, PaxosNode_nextSlotForProposer, PaxosNode_nextProposal, PaxosNode_proposeVal);

PaxosNode_BroadCastAcceptors(accept, _tmp445);

send PaxosNode_timer, startTimer;


}
fun PaxosNode_ProposeValuePhase2_exit0_rand_875807192()
{
...
{
var _tmp446: ((int, int), int);
var _tmp447: bool;


_tmp446 = (PaxosNode_RunLearner_entry306_receivedMess_1.1, PaxosNode_RunLearner_entry306_receivedMess_1.2);

PaxosNode_learnerSlots[PaxosNode_RunLearner_entry306_receivedMess_1.0] = _tmp446;

PaxosNode_RunReplicatedMachine();

_tmp447 = (PaxosNode_commitValue == PaxosNode_RunLearner_entry306_receivedMess_1.2);

if((PaxosNode_currCommitOperation && _tmp447))
{
...
fun PaxosNode_RunLearner_exit0_rand_485568929()
{
...
_tmp448 = (PaxosNode_ProposeValuePhase1_do_agree195_receivedMess.0 == PaxosNode_nextSlotForProposer);
...
_tmp449 = (PaxosNode_countAgree == PaxosNode_majority);
...
fun PaxosNode_Init_on_local_goto_PaxosNode_PerformOperation0_rand_1381604413()
{
...
fun PaxosNode_ProposeValuePhase1_on_timeout_goto_PaxosNode_ProposeValuePhase10_rand_1143281035()
{
...
fun PaxosNode_ProposeValuePhase2_on_timeout_goto_PaxosNode_ProposeValuePhase10_rand_8634636()
{
...
exit  {
PaxosNode_Init_exit0_rand_1004962824();
}
}
 state PaxosNode_PerformOperation
{entry  {
PaxosNode_PerformOperation_entry0_rand_2055431763();
}
exit  {
PaxosNode_PerformOperation_exit0_rand_1247339603();
}
}
...
exit  {
PaxosNode_ProposeValuePhase1_exit0_rand_805977634();
}
}
...
exit  {
PaxosNode_ProposeValuePhase2_exit0_rand_875807192();
}
}
...
exit  {
PaxosNode_RunLearner_exit0_rand_485568929();
}
}
}
...
fun LeaderElection_Init_exit0_rand_986450414()
{
...
fun LeaderElection_SendLeader_exit0_rand_2034420377()
{
...
fun LeaderElection_Init_on_local_goto_LeaderElection_SendLeader0_rand_920313249()
{
...
exit  {
LeaderElection_Init_exit0_rand_986450414();
}
}
...
exit  {
LeaderElection_SendLeader_exit0_rand_2034420377();
}
}
}
...
fun Timer_Init_exit0_rand_832627677()
{
...
fun Timer_Loop_entry0_rand_379273957()
{
...
fun Timer_Loop_exit0_rand_847283252()
{
...
fun Timer_TimerStarted_exit0_rand_1331088409()
{
...
fun Timer_Init_on_local_goto_Timer_Loop0_rand_1309315442()
{
...
fun Timer_Loop_on_startTimer_goto_Timer_TimerStarted0_rand_355552083()
{
...
fun Timer_TimerStarted_on_local_goto_Timer_Loop0_rand_606337782()
{
...
fun Timer_TimerStarted_on_cancelTimer_goto_Timer_Loop0_rand_143803119()
{
...
exit  {
Timer_Init_exit0_rand_832627677();
}
}
 state Timer_Loop
{entry  {
Timer_Loop_entry0_rand_379273957();
}
exit  {
Timer_Loop_exit0_rand_847283252();
}
}
...
exit  {
Timer_TimerStarted_exit0_rand_1331088409();
}
}
}
...
fun GodMachine_Init_exit0_rand_1528024695()
{
...
exit  {
GodMachine_Init_exit0_rand_1528024695();
}
}
}
...
fun Client_Init_exit0_rand_1323741459()
{
...
fun Client_PumpRequestOne_entry0_rand_809014464()
{
var _tmp462: bool;
var _tmp463: machine;
var _tmp464: (int, int);
...
fun Client_PumpRequestOne_exit0_rand_261634687()
{
...
fun Client_PumpRequestTwo_entry0_rand_1872250533()
{
var _tmp467: bool;
var _tmp468: machine;
var _tmp469: (int, int);
...
fun Client_PumpRequestTwo_exit0_rand_450177287()
{
...
fun Client_Done_entry0_rand_1958357028()
{
...
fun Client_Done_exit0_rand_306672044()
{
...
fun Client_Init_on_local_goto_Client_PumpRequestOne0_rand_1845977528()
{
...
fun Client_PumpRequestOne_on_response_goto_Client_PumpRequestTwo0_rand_1825398972()
{
...
fun Client_PumpRequestTwo_on_response_goto_Client_Done0_rand_433198160()
{
...
exit  {
Client_Init_exit0_rand_1323741459();
}
}
 state Client_PumpRequestOne
{entry  {
Client_PumpRequestOne_entry0_rand_809014464();
}
exit  {
Client_PumpRequestOne_exit0_rand_261634687();
}
}
 state Client_PumpRequestTwo
{entry  {
Client_PumpRequestTwo_entry0_rand_1872250533();
}
exit  {
Client_PumpRequestTwo_exit0_rand_450177287();
}
}
 state Client_Done
{entry  {
Client_Done_entry0_rand_1958357028();
}
exit  {
Client_Done_exit0_rand_306672044();
}
}
}
